...
class Room:
    ...
    def __init__(self, master):
        ...
        self.room_t1 = Label(self.LoginFrame,
        ...
        self.button5 = Button(self.LoginFrame2, text="ROOM DETAILS", width=15, font="Helvetica 14 bold",
                              bg="cadet blue", command=self.SEARCH_ROOM)
    ...
    def UPDATE_ROOM(self):
        ...
        if len(p) != 0:
            ...
            conn.execute(
                'UPDATE ROOM SET ROOM_NO=?,ROOM_TYPE=?,RATE=?,DATE_ADMITTED=?,DATE_DISCHARGED=? where PATIENT_ID=?',
                (r3, r2, r4, r5, r6, r1,))
...
class S_Room:
    ...
    def ROOM_DISPLAY(self):
        ...
        if (len(p) == 0):
            ...
            t = c1.execute('SELECT PATIENT_ID,NAME,ROOM_NO,ROOM_TYPE FROM ROOM NATURAL JOIN PATIENT where PATIENT_ID=?',
                           (pat_rm,));
            for i in t:
